...
- Bump `pytest` from 7.4.3 to 7.4.4 ([#8](https://github.com/MechanicalFlower/godot-asset-library-client/pull/8))
- Bump `attrs` from 23.1.0 to 23.2.0 ([#6](https://github.com/MechanicalFlower/godot-asset-library-client/pull/6))
- Bump `openapi-python-client` from 0.16.0 to 0.17.0 ([#7](https://github.com/MechanicalFlower/godot-asset-library-client/pull/7))
